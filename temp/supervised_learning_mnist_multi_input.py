...
from keras.layers import Conv2D, Flatten, Dense, Dropout, BatchNormalization, concatenate
...
c1 = Conv2D(32, kernel_size=3, activation='relu')(x1)
...
# digit recognizer
dr_d1 = Dense(512, activation='relu')(c)
...
bgr_d1 = Dense(256, activation='relu')(c)
bgr_d2 = Dense(3, activation='softmax', name='background_color_output')(bgr_d1)

model = Model(inputs=[x0, x1], outputs=[dr_d3, bgr_d2], name='MNIST_multitask')
